            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex items-start gap-16">
                    ...
                    <div className="flex flex-col gap-4">
                        <a href="" className="p-4 text-sm bg-blue-600 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-blue-800 transition-colors">
                            <DiscordLogo size={24} />
                            Comunidade no discord
                        </a>
                        <a href="" className="p-4 text-sm text-yellow-400 flex items-center font-bold uppercase gap-2 justify-center hover:underline transition-shadow">
                            <Lightning size={24} />
                            Acesse o desafio
                        </a>
                    </div>
